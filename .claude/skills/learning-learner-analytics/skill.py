...
class LearningLearnerAnalyticsSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.learner.analytics", skill_name="learning-learner-analytics", category="learning",
                        description="learning.learner.analytics for advanced learning functions")
    ...
    async def execute(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            "skill": "learning.learner.analytics",
...
skill_instance = LearningLearnerAnalyticsSkill()
