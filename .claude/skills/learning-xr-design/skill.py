...
class LearningXrDesignSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.xr.design", skill_name="learning-xr-design", category="learning",
                        description="learning.xr.design skill for learning experience design")
...
skill_instance = LearningXrDesignSkill()
