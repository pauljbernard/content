...
class LearningPlatformTrainingSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.platform.training", skill_name="learning-platform-training", category="learning",
                        description="learning.platform.training for learning support and infrastructure")
    ...
    async def execute(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            "skill": "learning.platform.training",
...
skill_instance = LearningPlatformTrainingSkill()
