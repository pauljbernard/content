#!/usr/bin/env python3
"""Learning.privacyComplianceSkill"""
import sys
...
class Learning.privacyComplianceSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.privacy.compliance", skill_name="learning.privacy-compliance", category="learning",
                        description="learning.privacy.compliance for globalization and compliance")
...
skill_instance = Learning.privacyComplianceSkill()
