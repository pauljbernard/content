...
class LearningPeerTutoringSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.peer.tutoring", skill_name="learning-peer-tutoring", category="learning",
                        description="learning.peer.tutoring for learning support and infrastructure")
...
skill_instance = LearningPeerTutoringSkill()
