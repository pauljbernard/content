...
class LearningTrainingNeedsSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.training.needs", skill_name="learning-training-needs", category="learning",
                        description="learning.training.needs for advanced learning functions")
...
skill_instance = LearningTrainingNeedsSkill()
