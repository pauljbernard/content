...
class LearningGameDesignerSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.game.designer", skill_name="learning-game-designer", category="learning",
                        description="learning.game.designer skill for learning experience design")
...
skill_instance = LearningGameDesignerSkill()
