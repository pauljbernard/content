...
class LearningOnboardingSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.onboarding", skill_name="learning-onboarding", category="learning",
                        description="learning.onboarding skill for learning experience design")
...
skill_instance = LearningOnboardingSkill()
