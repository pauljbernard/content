#!/usr/bin/env python3
"""LearningDiscussionDesignerSkill"""
import sys
...
class LearningDiscussionDesignerSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.discussion.designer", skill_name="learning-discussion-designer", category="learning",
                        description="learning.discussion.designer skill for learning experience design")
    ...
    async def execute(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            "skill": "learning.discussion.designer",
            "topic": topic,
            "level": level,
...
skill_instance = LearningDiscussionDesignerSkill()
