...
class LearningCefrAlignmentSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.cefr.alignment", skill_name="learning-cefr-alignment", category="learning",
                        description="learning.cefr.alignment for globalization and compliance")
...
skill_instance = LearningCefrAlignmentSkill()
