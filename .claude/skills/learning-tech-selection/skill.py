...
class LearningTechSelectionSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.tech.selection", skill_name="learning-tech-selection", category="learning",
                        description="learning.tech.selection for globalization and compliance")
...
skill_instance = LearningTechSelectionSkill()
