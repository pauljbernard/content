#!/usr/bin/env python3
"""Curriculum.plagiarismCheckSkill"""
import sys
...
class Curriculum.plagiarismCheckSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="curriculum.plagiarism.check", skill_name="curriculum.plagiarism-check",
                        category="standards" if "standards" in "curriculum.plagiarism.check" else "curriculum",
                        description="curriculum.plagiarism.check skill")
...
skill_instance = Curriculum.plagiarismCheckSkill()
