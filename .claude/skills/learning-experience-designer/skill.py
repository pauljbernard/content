#!/usr/bin/env python3
"""LearningExperienceDesignerSkill"""
import sys
...
class LearningExperienceDesignerSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.experience.designer", skill_name="learning-experience-designer", category="learning",
                        description="learning.experience.designer skill for learning experience design")
    ...
    async def execute(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            "skill": "learning.experience.designer",
            "topic": topic,
            "level": level,
...
skill_instance = LearningExperienceDesignerSkill()
