#!/usr/bin/env python3
"""LearningSimulationDesignerSkill"""
import sys
...
class LearningSimulationDesignerSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.simulation.designer", skill_name="learning-simulation-designer", category="learning",
                        description="learning.simulation.designer skill for learning experience design")
    ...
    async def execute(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            "skill": "learning.simulation.designer",
            "topic": topic,
            "level": level,
...
skill_instance = LearningSimulationDesignerSkill()
