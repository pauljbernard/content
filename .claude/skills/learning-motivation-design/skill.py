...
class LearningMotivationDesignSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.motivation.design", skill_name="learning-motivation-design", category="learning",
                        description="learning.motivation.design skill for learning experience design")
    ...
    async def execute(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            "skill": "learning.motivation.design",
            "topic": topic,
            "level": level,
...
skill_instance = LearningMotivationDesignSkill()
