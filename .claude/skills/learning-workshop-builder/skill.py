...
class LearningWorkshopBuilderSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.workshop.builder", skill_name="learning-workshop-builder", category="learning",
                        description="learning.workshop.builder skill for learning experience design")
    ...
    async def execute(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            "skill": "learning.workshop.builder",
            "topic": topic,
            "level": level,
...
skill_instance = LearningWorkshopBuilderSkill()
