...
class LearningAiIntegrationSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="learning.ai.integration", skill_name="learning-ai-integration", category="learning",
                        description="learning.ai.integration for advanced learning functions")
...
skill_instance = LearningAiIntegrationSkill()
