...
class StandardsCrosswalkMapperSkill(Skill):
    def __init__(self):
        super().__init__(skill_id="standards.crosswalk.mapper", skill_name="standards-crosswalk-mapper",
                        category="standards" if "standards" in "standards.crosswalk.mapper" else "curriculum",
                        description="standards.crosswalk.mapper skill")
    ...
    async def execute(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            "skill": "standards.crosswalk.mapper",
...
skill_instance = StandardsCrosswalkMapperSkill()
